...
import { heroArrowRight, heroStar, heroHeart, heroEye, heroChevronLeft, heroChevronRight, heroShieldCheck, heroSparkles, heroCurrencyDollar, heroTruck, heroGift, heroPhone } from '@ng-icons/heroicons/outline';
